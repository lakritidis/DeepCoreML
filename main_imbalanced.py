...
# evaluation_methods.eval_resampling(datasets=datasets, transformer='standardizer', num_folds=5, random_state=seed)
evaluation_methods.eval_detectability(datasets=imb_datasets, transformer='standardizer', num_folds=5, random_state=seed)
